      ...
      <div className="intro_cali" id="scrollContainer">
        <div className="intro_cali_content panel  ">
          ...
          <p className="fs-16px fs-md-14px text-white fw-300">
            ...
            The base price of $TRACK will be determined following the completion of the IDO on Fjord Foundry (formerly Copper Launch).
        ...
        <div className="intro_cali_content panel ">
          ...
          <p className="fs-16px fs-md-14px text-white fw-300">
            The current total floor price of the Blue Chip NFT index is approx 121 ETH (1/30/2023).
            Let us assume that this remains the same until DEX launch.
            This 121 ETH represents the base price from which to match to the initial launch price of $TRACK. (in our assumptions, $1.00).
          </p>
        </div>
        <div className="intro_cali_content panel ">
